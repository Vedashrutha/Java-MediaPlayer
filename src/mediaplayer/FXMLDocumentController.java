...
public class FXMLDocumentController implements Initializable {
    ...
    private void handleButtonAction(ActionEvent event){
        extensions= Arrays.asList("*.mp4","*.3gp","*.mkv","*.MP4","*.MKV","*.3GP","*.flv","*.wmv","*.mp3");
        ...
        if(filePath!= null){
            ...
            mediaView.setMediaPlayer(mediaPlayer);
              ...
              /*  slider.valueProperty().addListener((Observable obeservable) -> {
                ...
                mediaPlayer.setOnReady(() -> {
                    ...
                    mediaSlider.setOnMouseClicked((MouseEvent event1) -> {
